...
const SEED_UPDATES = [
  {
    ...
    description:
      "The European Commission has confirmed Apple's Core Technology Commission of 5% on all external purchase transactions under the DMA. This fee applies in addition to payment processor fees and is automatically calculated by EUPay.",
    actionRequired:
      "No action needed — EUPay handles CTC calculation and disclosure automatically. Review the Cost Calculator in your dashboard to understand the impact on your pricing.",
  ...
  },
  {
    ...
    actionRequired:
      "Review your fee structure using the Cost Calculator. If you earn under €1M/year, compare EUPay's total fees (~11.5%) against Apple's new 20% rate to confirm EUPay remains the better option for your business.",
  ...
  },
  {
    ...
    actionRequired:
      "Ensure Apple credentials are configured for all your apps. EUPay automatically reports transactions and submits monthly nil reports. Check the Apple Reporting page in each app's dashboard to verify your reporting status.",
