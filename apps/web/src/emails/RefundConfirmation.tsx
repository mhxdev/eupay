...
export default function RefundConfirmation({
  ...
  const date =
    refundedAt instanceof Date ? refundedAt : new Date(refundedAt)

  return (
    <Html lang="en">
      <Head />
      <Preview>
        Refund confirmation — {appName}
      </Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Text style={heading}>Refund Confirmation</Text>
            <Text style={paragraph}>
              Your refund has been processed. The amount will be returned to
